 ...
 * @returns A structured object containing extracted job details
 */
export const analyzeJob = async (text: string) => {
  const response = await AIRequest('gpt-4o', prompts.getJobdescription, text);
